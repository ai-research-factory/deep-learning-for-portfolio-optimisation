...
| Metric | Value |
|---|---|
| Gross Sharpe (avg) | 0.9899 |
| Net Sharpe (avg) | 0.8945 |
| Annual Return | 13.12% |
| Max Drawdown | -14.50% |
| Hit Rate | 55.0% |
...
|---|---|---|---|---|
| 1 | 2022-06 to 2023-03 | -0.6916 | 0.1384 | No |
| 2 | 2023-03 to 2023-12 | 0.7950 | 1.4771 | No |
| 3 | 2023-12 to 2024-09 | 1.8240 | 1.6275 | Yes |
| 4 | 2024-09 to 2025-06 | 0.5799 | 0.6331 | No |
| 5 | 2025-06 to 2026-03 | 1.9650 | 1.6444 | Yes |

## Observations

1. **Model vs Baseline**: The LSTM model's average net Sharpe (0.89) is below the 1/N baseline (1.10). However, the model outperforms in 2 of 5 windows, with strongest performance in later windows as training data grows.
...
3. **Improving with Data**: Later windows (3, 5) outperform the baseline, suggesting the model benefits from expanding training windows. This is consistent with deep learning models requiring sufficient data.

4. **Transaction Costs**: The gap between gross Sharpe (0.99) and net Sharpe (0.89) shows ~10bp impact from the 15bps total cost model (10bps fee + 5bps slippage).
